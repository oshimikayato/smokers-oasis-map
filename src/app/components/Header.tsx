        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <Link href="/" className="flex items-center space-x-3" aria-label="ホームページへ戻る">
            ...
            <nav className="hidden md:flex items-center space-x-8" role="navigation" aria-label="メインナビゲーション">
              ...
              <Link href="/quit-challenge" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">
                禁煙チャレンジ
              </Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="btn btn-primary" aria-label="新しい喫煙所を登録">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {isMenuOpen && (
            <div className="md:hidden animate-fade-in" id="mobile-menu" role="navigation" aria-label="モバイルメニュー">
              <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
                ...
                <Link href="/quit-challenge" className="block px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition-colors">
                  禁煙チャレンジ
                </Link>
                ...
                <div className="pt-4 space-y-2">
                  ...
                  <button className="w-full btn btn-primary justify-start" aria-label="新しい喫煙所を登録">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                    <span className="ml-2">新規登録</span>
        ...
        >
          <div className="modal-content card p-6 max-w-md w-full mx-4">
            <div className="flex items-center justify-between mb-6">
              <h3 id="stats-modal-title" className="text-xl font-bold text-gray-800">📊 統計情報</h3>
              <button
